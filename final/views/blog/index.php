...
<?php include('views/elements/header.php');?>
    ...
    <div class="container">
        ...
        <?php foreach($posts as $p){?>
            ...
            <sub><?php echo 'Posted on ' . $p[date] . ' by <a href="'.BASE_URL.'members/view/'. $p[uid]. '">' . $p[first_name] . ' ' . $p[last_name] . '</a> in <a href="'.BASE_URL.'blog/category/'. $p[categoryid].'">' . $p[name] .'</a>' ?></sub>
