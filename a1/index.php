...
<div id="wrapper">
	...
	<form action="<?php echo URL_ROOT . '/add_products_to_inventory.php' //removed quotes from URL_ROOT to make the save button work and redirect correctly ?>" method="post">
	...
	//Removed ")", put in "}" to fix error and make page work
}
	?>
